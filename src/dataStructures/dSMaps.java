...
public class dSMaps {
     ...
     * 
     * HashMap: Triển khai "Map" giao diện bằng cách sử dụng bảng băm. Các phần tử được
     ...
     * 
     * LinkedHashMap: Mở rộng "HashMap" và duy trì một danh sách các phần tử được
     * liên kết
     ...
     * 
     * TreeMap: Thực hiện giao diện bằng cây đỏ-đen. Các phần tử được lưu trữ theo
     ...
     * bảo cho hầu hết các hoạt động, bao gồm thêm, xóa và chứa. "SortedMap"
     */
